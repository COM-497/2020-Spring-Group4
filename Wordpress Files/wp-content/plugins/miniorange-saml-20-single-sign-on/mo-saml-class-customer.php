...
class Customersaml {
	...
	function send_email_alert($email,$phone,$message, $demo_request=false){
		...
		if($demo_request)
			$subject = "DEMO Request: WordPress SAML 2.0 SSO Plugin";
		$site_url=site_url();
    ...
    function enable_guest_audit($in_use) {
        ...
        $url = mo_saml_options_plugin_constants::HOSTNAME. "/moas/rest/customer/guest-audit";
        ...
        $fields = array (
            ...
            'companyName' =>$domain,
            'cmsName' => mo_saml_options_plugin_constants::CMS_Name,
            'pluginVersion' => mo_saml_options_plugin_constants::Version,
            'applicationName' => mo_saml_options_plugin_constants::Application_Name,
            'applicationType' => mo_saml_options_plugin_constants::Application_type,
            'inUse' => $in_use
        );
        $field_string = json_encode ( $fields );
